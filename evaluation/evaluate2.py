...
for g, g_name in {0:'0', 0.1:'0_1', 0.05: '0_05', 
    0.2:'0_2'
        }.items(): 
    ...
    for epoch in np.arange(0, 201, 25):
        ...
        print("*"*20)
        sample_path = f'/home/ymbahram/projects/def-hadi87/ymbahram/improved_diffusion/clf_trg_results/fixed_guidance_dataset/data100/{g_name}/samples/samples_{epoch}.npz'
    ...
    csv_file = f"/home/ymbahram/projects/def-hadi87/ymbahram/improved_diffusion/clf_trg_results/fixed_guidance_dataset/data100/evaluation.csv"
