        ...
        for mode in modes: 
            ...
            for g, g_name in {0:'0'
                ...
                for dataset_size in [10]:
                    ...
                    file_path = f"/export/livia/home/vision/Ymohammadi/baselines_avg/a3ft/data10/samples_10k/evaluate_all.csv"
                    
                    print("__________________________ STARTING FROM FIRST EPOCH_____________________")

                    sample_path = f"/export/livia/home/vision/Ymohammadi/baselines_avg/a3ft/data10/samples_10k/10k_samples_repeat{repetition}.npz"
