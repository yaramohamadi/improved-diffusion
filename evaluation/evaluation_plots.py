...
colors = plt.cm.Reds(np.linspace(0.3, 1, 4))  # Shades of red
...
create_scaled_line(0.8, 1.2, color=colors[0], a=0)
create_scaled_line(0.8, 1.2, color=colors[1], a=-2.5)
create_scaled_line(0.8, 1.2, color=colors[2], a=-5)
create_scaled_line(0.8, 1.2, color=colors[3], a=-7.5)
...
# Show the plot
plt.tight_layout()
plt.savefig('/home/ymbahram/projects/def-hadi87/ymbahram/improved_diffusion/clf_results/curved_schedule/evaluation-0_8-1_2.png')