    ...
    for p2_gamma in [0]: # TODO Quoi??
        ...
        for lambda_1 in [0.1, 0.5, 1]:
            ...
            for lambda_2 in [0.1, 0.5, 1]:
                ...
                for lambda_3 in [0.01, 0.04, 0.08]:

                    for dataset_size in [10]:

                        file_path = f"/home/ymbahram/scratch/baselines/ddpm-pa/data{dataset_size}/FID_KID_lambdas.csv"
                        ...
                        for epoch in [0, 25, 50, 75, 100, 125, 150, 175, 200]:
                            ...
                            print("*"*20)
                            sample_path = f"/home/ymbahram/scratch/baselines/ddpm-pa/data{dataset_size}/l1_{lambda_1}_l2_{lambda_2}_l3_{lambda_3}/samples/samples_{epoch}.npz"
