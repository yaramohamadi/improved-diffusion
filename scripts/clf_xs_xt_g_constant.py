            ...
            for dataset_size in [10]:
                ...
                for g in [ 0, 0.001, 0.05, 0.1, 0.3, 0.5, 0.7, 0.9, 1]:  # 0, 0.1, 0.3, 0.5, 0.7, 0.9, 1 0.1    0.1, 
                    ...
                    for gamma in [0]:
                        ...
                        loss_logger = os.path.join(base_path, f"clf_results/clf_xs_xt/constant_alternate_variance/g{g}/trainlog.csv")
                        # If evaluation is true during training, where to save the FID stuff
                        eval_logger = os.path.join(base_path, f"clf_results/clf_xs_xt/constant_alternate_variance/g{g}/evallog.csv")
                        # Directory to save checkpoints in
                        checkpoint_dir = os.path.join(base_path, f"clf_results/clf_xs_xt/constant_alternate_variance/g{g}/tmpcheckpoints/")
                        # Whenever you are saving checkpoints, a batch of images are also sampled, where to produce these images
                        save_samples_dir= os.path.join(base_path, f"clf_results/clf_xs_xt/constant_alternate_variance/g{g}/samples/")
