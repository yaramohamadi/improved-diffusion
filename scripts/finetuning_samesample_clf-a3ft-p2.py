    ...
    for dataset_size in [10]:
        ...
        for g in [0, 0.01, 0.05, 0.1]:
            ...
            for gamma in [0, 0.1, 10]:
                ...
                loss_logger=f"/home/ymbahram/scratch/clf_trg_results/results_samesample/g_p2_a3ft/data{dataset_size}/{mode}/g{g}_gamma{gamma}/trainlog.csv"
                # If evaluation is true during training, where to save the FID stuff
                eval_logger=f"/home/ymbahram/scratch/clf_trg_results/results_samesample/g_p2_a3ft/data{dataset_size}/{mode}/g{g}_gamma{gamma}/evallog.csv"
                # Directory to save checkpoints in
                checkpoint_dir = f"/home/ymbahram/scratch/clf_trg_results/results_samesample/g_p2_a3ft/data{dataset_size}/{mode}/g{g}_gamma{gamma}/checkpoints/"
                # Whenever you are saving checkpoints, a batch of images are also sampled, where to produce these images
                save_samples_dir= f"/home/ymbahram/scratch/clf_trg_results/results_samesample/g_p2_a3ft/data{dataset_size}/{mode}/g{g}_gamma{gamma}/samples/"
