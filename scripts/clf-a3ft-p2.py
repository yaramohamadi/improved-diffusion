            ...
            for g_clg in [0]:  # 0.001, 0.01, 0.1
                for gamma_clf in [0, 0.1, 1, 10]:
                    for gamma_clg in [0]: # , 0.1, 1, 10
                        ...
                        print("*"*20)
                        print(f"g_clf is {g_clf} gamma_clf is {gamma_clf} mode is {mode}")
                        print("*"*20)
                        ...
                        loss_logger=f"/export/livia/home/vision/Ymohammadi/clf_results/clf_{mode}/data{dataset_size}/g{g_clf}_gamma_clf{gamma_clf}/trainlog.csv"
                        # If evaluation is true during training, where to save the FID stuff
                        eval_logger=f"/export/livia/home/vision/Ymohammadi/clf_results/clf_{mode}/data{dataset_size}/g{g_clf}_gamma_clf{gamma_clf}/evallog.csv"
                        # Directory to save checkpoints in
                        checkpoint_dir = f"/export/livia/home/vision/Ymohammadi/clf_results/clf_{mode}/data{dataset_size}/g{g_clf}_gamma_clf{gamma_clf}/checkpoints/"
                        # Whenever you are saving checkpoints, a batch of images are also sampled, where to produce these images
                        save_samples_dir= f"/export/livia/home/vision/Ymohammadi/clf_results/clf_{mode}/data{dataset_size}/g{g_clf}_gamma_clf{gamma_clf}/samples/"
