...
for dataset_size in [10]:#, 100, 700, 2503]:
    ...
    for p2_gamma in [0.1]: #, 0.3, 1, 3, 10]:
        ...
        for g, g_name in {
            ...
            loss_logger=f"/home/ymbahram/scratch/clf_trg_results/results_samesample/time-step/data{dataset_size}_2/{g_name}_{p2_gamma}/trainlog.csv"
            # If evaluation is true during training, where to save the FID stuff
            eval_logger=f"/home/ymbahram/scratch/clf_trg_results/results_samesample/time-step/data{dataset_size}_2/{g_name}_{p2_gamma}/evallog.csv"
            # Directory to save checkpoints in
            checkpoint_dir = f"/home/ymbahram/scratch/clf_trg_results/results_samesample/time-step/data{dataset_size}_2/{g_name}_{p2_gamma}/checkpoints/"
            # Whenever you are saving checkpoints, a batch of images are also sampled, where to produce these images
            save_samples_dir= f"/home/ymbahram/scratch/clf_trg_results/results_samesample/time-step/data{dataset_size}_2/{g_name}_{p2_gamma}/samples/"
