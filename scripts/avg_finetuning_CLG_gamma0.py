...
for repetition in range(3):
    ...
    for dataset_size in [10]:
        ...
        for g in [
            ...
            loss_logger=f"/home/ymbahram/scratch/baselines_avg/classifier-guidance/data{dataset_size}/gamma0_g{g}_repeat{repetition}/trainlog.csv"
            # If evaluation is true during training, where to save the FID stuff
            eval_logger=f"/home/ymbahram/scratch/baselines_avg/classifier-guidance/data{dataset_size}/gamma0_g{g}_repeat{repetition}/evallog.csv"
            # Directory to save checkpoints in
            checkpoint_dir = f"/home/ymbahram/scratch/baselines_avg/classifier-guidance/data{dataset_size}/gamma0_g{g}_repeat{repetition}/checkpoints" 
            # Whenever you are saving checkpoints, a batch of images are also sampled, where to produce these images
            save_samples_dir= f"/home/ymbahram/scratch/baselines_avg/classifier-guidance/data{dataset_size}/gamma0_g{g}_repeat{repetition}/samples/"
