                    ...
                    for gamma in [0]:
                        ...
                        for gamma_clf in []: 
                            ...
                            for gamma_clg in []:
                                ...
                                # Fixed
                                guidance_scale_clf = np.array([g for _ in range(epochs)]) # Fixed Line
                                guidance_scale_clg = np.array([g for _ in range(epochs)]) # Fixed Line

                                # Where to log the training loss (File does not have to exist)
                                loss_logger=f"/home/ymbahram/scratch/baselines_avg/classifier-free/data{dataset_size}/{mode}/g{g}_gamma{gamma}_repetition{repetition}/trainlog.csv"
                                # If evaluation is true during training, where to save the FID stuff
                                eval_logger=f"/home/ymbahram/scratch/baselines_avg/classifier-free/data{dataset_size}/{mode}/g{g}_gamma{gamma}_repetition{repetition}/evallog.csv"
                                # Directory to save checkpoints in
                                checkpoint_dir = f"/home/ymbahram/scratch/baselines_avg/classifier-free/data{dataset_size}/{mode}/g{g}_gamma{gamma}_repetition{repetition}/checkpoints/"
                                # Whenever you are saving checkpoints, a batch of images are also sampled, where to produce these images
                                save_samples_dir= f"/home/ymbahram/scratch/baselines_avg/classifier-free/data{dataset_size}/{mode}/g{g}_gamma{gamma}_repetition{repetition}/samples/"
