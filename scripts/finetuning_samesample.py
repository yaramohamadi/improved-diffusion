...
for dataset_size in [10]:#, 100, 700, 2503]:
    ...
    for g, g_name in {
        ...
        loss_logger=f"/home/ymbahram/projects/def-hadi87/ymbahram/improved_diffusion/clf_trg_results/results_samesample/data{dataset_size}_2/{g_name}/trainlog.csv"
        # If evaluation is true during training, where to save the FID stuff
        eval_logger=f"/home/ymbahram/projects/def-hadi87/ymbahram/improved_diffusion/clf_trg_results/results_samesample/data{dataset_size}_2/{g_name}/evallog.csv"
        # Directory to save checkpoints in
        checkpoint_dir = f"/home/ymbahram/projects/def-hadi87/ymbahram/improved_diffusion/clf_trg_results/results_samesample/data{dataset_size}_2/{g_name}/checkpoints/"
        # Whenever you are saving checkpoints, a batch of images are also sampled, where to produce these images
        save_samples_dir= f"/home/ymbahram/projects/def-hadi87/ymbahram/improved_diffusion/clf_trg_results/results_samesample/data{dataset_size}_2/{g_name}/samples/"
