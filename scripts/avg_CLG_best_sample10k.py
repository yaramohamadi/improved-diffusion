...
for repetition in range(3):
    ...
    for p2_gamma in [0]:
        ...
        # PATHS  
            load_model_paths = [
            f'/export/livia/home/vision/Ymohammadi/baselines_avg/CLG/data10/gamma0.1_g1_repeat0/checkpoints/model000125.pt',
            f'/export/livia/home/vision/Ymohammadi/baselines_avg/CLG/data10/gamma0.1_g1_repeat1/checkpoints/model000050.pt',
            f'/export/livia/home/vision/Ymohammadi/baselines_avg/CLG/data10/gamma0.1_g1_repeat2/checkpoints/model000100.pt',
            ]

            save_samples_dirs= [
            f"/export/livia/home/vision/Ymohammadi/baselines_avg/CLG/data10/samples_10k/",
            f"/export/livia/home/vision/Ymohammadi/baselines_avg/CLG/data10/samples_10k/",
            f"/export/livia/home/vision/Ymohammadi/baselines_avg/CLG/data10/samples_10k/"
            ]
